...
mag_cpu_impl_reduce_axes(mag_bfloat16_t, mag_bfloat16_t, bfloat16, min, float, INFINITY, acc = fminf(acc, mag_bfloat16_to_float32(bx[roff]));, *o = mag_float32_to_bfloat16(acc); )
mag_cpu_impl_reduce_axes(mag_float8_e4m3fn_t, mag_float8_e4m3fn_t, float8_e4m3fn, min, float, INFINITY, acc = fminf(acc, mag_float8_e4m3fn_to_float32(bx[roff]));, *o = mag_float32_to_float8_e4m3fn(acc); )
...
mag_cpu_impl_reduce_axes(mag_bfloat16_t, mag_bfloat16_t, bfloat16, max, float, -INFINITY, acc = fmaxf(acc, mag_bfloat16_to_float32(bx[roff]));, *o = mag_float32_to_bfloat16(acc); )
mag_cpu_impl_reduce_axes(mag_float8_e4m3fn_t, mag_float8_e4m3fn_t, float8_e4m3fn, max, float, -INFINITY, acc = fmaxf(acc, mag_float8_e4m3fn_to_float32(bx[roff]));, *o = mag_float32_to_float8_e4m3fn(acc); )
